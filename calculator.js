...
var holdTime = 26; //makes it choose the first selection faster
//var holdSeq;
$(document).on('keydown', function(event) { //Changed to on keydown
	if (event.key == "a") {
...
//Keyup
$(document).on('keyup', function(event) { //Changed to on keydown
	if (event.key == "a") {
		//alert("You pressed the 'a' key!");
        clickSelectedItem();
        holdTime = 26; //makes it choose the first selection faster
        }
})
